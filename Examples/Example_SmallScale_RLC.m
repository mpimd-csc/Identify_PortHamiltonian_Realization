% -------------------------------------------------------------------------
% This example demonstrates the method for Example 7.2 in the paper
%
...
% 2019. 
%
% The model in this example is taken from the paper "A. C. Antoulas, A new 
% result on passivity preserving model reduction, Systems Control Lett.
% 54 (4) (2005) 361--374".
...
[IdenpHModel, out]  = Construct_pHModel(w,F,D);
